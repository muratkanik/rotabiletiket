...
export function SolutionForm({ solution }: { solution: any }) {
    ...
    return (
        <form ref={formRef} action={formAction} className="space-y-6 rounded-xl border border-slate-200 bg-white p-6">
            ...
            <div className="grid gap-4 rounded-lg border border-blue-200 bg-blue-50 p-4 md:grid-cols-[220px_1fr] md:items-center"><label className="text-sm font-semibold text-blue-950">Kaynak içerik dili<select name="source_language" defaultValue="tr" className="mt-2 w-full rounded-lg border border-blue-300 bg-white px-3 py-2 font-normal text-slate-900"><option value="tr">Türkçe</option><option value="en">English</option><option value="de">Deutsch</option><option value="fr">Français</option><option value="ar">العربية</option><option value="es">Español</option><option value="it">Italiano</option></select></label><label className="flex items-start gap-3 text-sm text-blue-950"><input type="checkbox" name="auto_translate" defaultChecked className="mt-1" /><span><strong>Kaydederken tüm dillere otomatik çevir</strong><br /><span className="text-blue-900/75">Seçilen kaynak içerik dili Türkçe ana kayda ve diğer tüm dillere AI ile çevrilir.</span></span></label></div>
