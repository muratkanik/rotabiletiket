...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    return {
        ...
        // Every page gets a self-referencing canonical ('./' is resolved against the
        // current pathname). Pages that define their own `alternates` override this.
        // hreflang links are only emitted on the home page (see [locale]/page.tsx),
        // because pointing every sub page's hreflang at the home pages is invalid.
        alternates: {
            canonical: './',
        },
        icons: {
