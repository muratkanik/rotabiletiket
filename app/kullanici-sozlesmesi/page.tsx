...
export const metadata = {
    ...
    description: 'Site kullanım koşulları ve yasal uyarılar.'
}

export default async function UserAgreementPage() {
    const agreement = await getSiteSettings('user_agreement');
    ...
    return (
        <main className="min-h-screen bg-slate-50">
            ...
            <div className="bg-slate-900 py-16 text-white text-center">
                <h1 className="text-3xl md:text-4xl font-bold mb-4">{agreement?.title || 'Kullanıcı Sözleşmesi'}</h1>
                <p className="text-slate-400">Genel Kullanım Şartları</p>
            </div>
